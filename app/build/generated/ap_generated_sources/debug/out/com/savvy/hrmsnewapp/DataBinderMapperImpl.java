...
import com.savvy.hrmsnewapp.databinding.FragmentWfhLayoutBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTWFHLAYOUT = 2;

  private static final int LAYOUT_INOUTREQUESTFRAGMENT = 3;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.savvy.hrmsnewapp.R.layout.fragment_wfh_layout, LAYOUT_FRAGMENTWFHLAYOUT);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_FRAGMENTWFHLAYOUT: {
          if ("layout/fragment_wfh_layout_0".equals(tag)) {
            return new FragmentWfhLayoutBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for fragment_wfh_layout is invalid. Received: " + tag);
        }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/fragment_wfh_layout_0", com.savvy.hrmsnewapp.R.layout.fragment_wfh_layout);
