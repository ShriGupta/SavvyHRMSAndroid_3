...
public class GoogleServices extends Service implements LocationListener {
    ...
    public GoogleServices(Context mContext) {
...
//                            }
                   /* } catch (SecurityException e) {
                        Log.d("Exception Network", e.getMessage());
                        e.printStackTrace();
                    }*/
                }
...
//        final AmazingStatus status = new AmazingStatus();
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(GoogleServices.this);
        }
    }
