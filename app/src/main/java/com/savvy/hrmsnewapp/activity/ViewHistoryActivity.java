...
public class ViewHistoryActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ODApprovalFragment(), "OD Approval");
        adapter.addFragment(new LeaveApprovalFragment(), "Leave Approval");
        adapter.addFragment(new CompOffApproval(), "Comp Off Approval");
        adapter.addFragment(new PunchApprovalFragment(), "Punch Approval");
