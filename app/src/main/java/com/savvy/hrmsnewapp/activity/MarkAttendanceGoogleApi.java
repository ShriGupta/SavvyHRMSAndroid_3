...
/**
 * Created by orapc7 on 13/12/2017.
 */

public class MarkAttendanceGoogleApi extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        com.google.android.gms.location.LocationListener, View.OnClickListener{

    CoordinatorLayout coordinatorLayout;
    CurrentDateTimeAsynTask profileasynctask;
...
//        new AddNewLocationInPopUp().execute();
    ...
    private synchronized void setUpGClient() {
        googleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(MarkAttendanceGoogleApi.this, 0, this)
    ...
    private void getCurrentDateTime() {
        try {
            if (Utilities.isNetworkAvailable(this)) {
                profileasynctask = new CurrentDateTimeAsynTask();
        ...
        switch (v.getId()) {
            case R.id.btn_submit:
                if(mylocation!=null){
                    ...
                    markAttendancePost(commentreplace, String.valueOf(latitude), String.valueOf(longitude));
                } else{
                    getMyLocation();
    ...
    public Location getMyLocation(){
        if(googleApiClient!=null) {
            if (googleApiClient.isConnected()) {
                int permissionLocation = ContextCompat.checkSelfPermission(MarkAttendanceGoogleApi.this,
                ...
                if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                    ...
                    LocationServices.FusedLocationApi.requestLocationUpdates(googleApiClient, locationRequest, MarkAttendanceGoogleApi.this);
...
//                                            Toast.makeText(MarkAttendanceGoogleApi.this, "Location Resolution "+latitude+","+longitude, Toast.LENGTH_SHORT).show();
                                        ...
                                        status.startResolutionForResult(MarkAttendanceGoogleApi.this,
...
//                        moveMap();
    ...
    private class CurrentDateTimeAsynTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MarkAttendanceGoogleApi.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                JSONParser jParser = new JSONParser(MarkAttendanceGoogleApi.this); // get JSON data from URL JSONArray json = jParser.getJSONFromUrl(url);
    ...
    public class AddNewLocationInPopUp extends AsyncTask<Void, Void, Location> {
        ...
        protected void onPostExecute(final Location location) {
            ...
            if(location!=null) {
                ...
                Toast.makeText(MarkAttendanceGoogleApi.this, "Location Post "+latitude, Toast.LENGTH_SHORT).show();
                    ...
                    public void run(){
                        try{
                            ...
                            if(location!=null){
                                latitude = location.getLatitude();
                                longitude = location.getLongitude();
                                Toast.makeText(MarkAttendanceGoogleApi.this, "Location Thread "+latitude, Toast.LENGTH_SHORT).show();
                                pDialog.dismiss();
                            } else{
                                Toast.makeText(MarkAttendanceGoogleApi.this, "Location Not Found ", Toast.LENGTH_SHORT).show();
                                pDialog.dismiss();
                            }
                        }
                    }
                ...
                thread.start();
                Toast.makeText(MarkAttendanceGoogleApi.this, "Location Else "+latitude, Toast.LENGTH_SHORT).show();
