...
public class WorkFromHomeApprovalMMTAdapter extends RecyclerView.Adapter<WorkFromHomeApprovalMMTAdapter.MyViewHolder> {
    ...
    public WorkFromHomeApprovalMMTAdapter(Context context, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.work_from_home_approval_mmt_adapter, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.reason.setText(hashMap.get("WFH_REASON"));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            tokenNo = itemView.findViewById(R.id.wfhMMTApproval_TokenNo);
            empCode = itemView.findViewById(R.id.wfhMMTApproval_EmpCode);
            empName = itemView.findViewById(R.id.wfhMMTApproval_EmpName);
            fromDate = itemView.findViewById(R.id.wfhMMTApproval_FromDate);
            toDate = itemView.findViewById(R.id.wfhMMTApproval_ToDate);
            type = itemView.findViewById(R.id.wfhMMTApproval_Type);
            reason = itemView.findViewById(R.id.wfhMMTApproval_Reason);
            approvalCheckBoxMMT = itemView.findViewById(R.id.wfhapprovalCheckBoxMMT);
        ...
        private void saveXMLData(int adapterPosition) {
            ...
            stringBuilder.append("@").
                    ...
                    append(arrayList.get(adapterPosition).get("WFH_STATUS").equals("null") ? "" : arrayList.get(adapterPosition).get("WFH_STATUS")).append(",").
                    append(arrayList.get(adapterPosition).get("WFH_EMPLOYEE_ID")).append(",").
