...
public class CurrencySpinnerAdapter extends BaseAdapter {
    ...
    public CurrencySpinnerAdapter(Context applicationContext, ArrayList<HashMap<String, String>> status) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        statusnames.setText(statusarraylist.get(position).get("VALUE"));
        return view;
