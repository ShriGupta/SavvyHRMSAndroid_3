...
public class ODStatusListAdapter extends RecyclerView.Adapter<ODStatusListAdapter.MyViewHolder> {
    ...
    public ODStatusListAdapter(Context context, CoordinatorLayout coordinatorLayout, List<HashMap<String, String>> data) {
        this.data = data;
        this.coordinatorLayout = coordinatorLayout;
    }

    @Override
    public ODStatusListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.od_status_row, parent, false);
        return new ODStatusListAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(ODStatusListAdapter.MyViewHolder holder, int position) {
        HashMap<String, String> mapdata = data.get(position);
        try {
            String OdRequestSubType = mapdata.get("OD_REQUEST_SUB_TYPE_NAME");
            ...
            holder.txt_odType_value.setText(mapdata.get("OD_TYPE_NAME"));
            holder.txt_odRequestType_value.setText(mapdata.get("OD_REQUEST_TYPE_NAME"));
            holder.txt_odRequestSubType_value.setText(mapdata.get("OD_REQUEST_SUB_TYPE_NAME"));
