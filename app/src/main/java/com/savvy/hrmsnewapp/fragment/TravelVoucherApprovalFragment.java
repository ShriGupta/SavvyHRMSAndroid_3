...
public class TravelVoucherApprovalFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Utilities.isNetworkAvailable(getActivity())){
            getTravelVoucherApprovalStatus();
        } else{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.travel_voucher_approval_fragment, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        linearNoDataFound = getActivity().findViewById(R.id.linearNoDataFound);

        linearNoDataFound.setVisibility(View.GONE);

        recyclerView = getActivity().findViewById(R.id.recyclerTravelApproval);
        mAdapter = new ApprovalVoucherDetailAdapter("Travel",getActivity(), arlData);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());

        recyclerView.addOnItemTouchListener(new TravelVoucherApprovalFragment.RecyclerTouchListener(getActivity(),recyclerView,new TravelVoucherApprovalFragment.ClickListener(){
                        ...
                        public void onClick(View v) {
                            try {
                                ...
                                if (token_no.equals(str)) {
                                    ...
                                    XML_CONVEYANCE_STATUS = mapdata.get("TRAVEL_VOUCHER_STATUS");
                                    XML_CR_EMPLOYEE_ID = mapdata.get("TVR_EMPLOYEE_ID");
                                    XML_ERFS_REQUEST_FLOW_ID = mapdata.get("ERFS_REQUEST_FLOW_ID");
                                    XML_APPROVED_ADVANCE_AMOUNT = mapdata.get("TVR_APPROVED_AMOUNT");
                                ...
                                txt_header.setText("Travel Voucher Approve/Reject");
                                ...
                                btn_ApproveGo.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if (comment.equals("")) {
                                            ...
                                            sendTravelVoucherApprovalRequest(comment, tg_text, xmlData);
                                            dialog.dismiss();
                                        }
                                    }
                                });
    ...
    public void getTravelVoucherApprovalStatus(){
        try {
            arlData = new ArrayList<HashMap<String,String>>();
            ...
            String url = Constants.IP_ADDRESS+"/SavvyMobileService.svc/GetTravelVoucherRequestDetail";
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try{
                                ...
                                JSONArray jsonArray = response.getJSONArray("GetTravelVoucherRequestDetailResult");
...
//                                    System.out.println("ArrayList==" + arlData);
    ...
    public void sendTravelVoucherApprovalRequest(String comment, String toggletext, String xmlData){
        try {
            arlData = new ArrayList<HashMap<String,String>>();
            final ProgressDialog pDialog;
            pDialog = new ProgressDialog(getActivity());
            ...
            String url = Constants.IP_ADDRESS+"/SavvyMobileService.svc/ProcessTravelVoucherRequest";
            final JSONObject pm = new JSONObject();
            JSONObject params_final = new JSONObject();
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, pm,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try{
                                String result = response.getString("ProcessTravelVoucherRequestResult");

                                int res = Integer.valueOf(result);
                                if (res > 0) {
                                    Utilities.showDialog(coordinatorLayout, "Travel Voucher Request processed sucessfully.");
                                    getTravelVoucherApprovalStatus();
                                } else if (res == 0) {
                                    Utilities.showDialog(coordinatorLayout, "Error during processing of Travel Voucher Request.");
//                                    getTravelVoucherApprovalStatus();
                                }
                            }catch (Exception ex){
                                ex.printStackTrace();
    ...
    static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private TravelVoucherApprovalFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final TravelVoucherApprovalFragment.ClickListener clickListener) {
