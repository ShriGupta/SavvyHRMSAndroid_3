...
import com.savvy.hrmsnewapp.activity.ItineraryDetailsWithTicketsActivity;
import com.savvy.hrmsnewapp.adapter.TravelDeskHistoryFicciAdapter;
...
public class TravelDeskHistoryFicciFragment extends BaseFragment {

    TravelDeskHistoryFicciAdapter travelDeskHistoryFicciAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getTravelDeskHistoryData("1");
        shared = getActivity().getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
    }

    private void getTravelDeskHistoryData(String value) {
        ...
        if (Utilities.isNetworkAvailable(getActivity())) {
            ...
            final String GET_TRAVELDESKHISTORY_URL = Constants.IP_ADDRESS + "/SavvyMobileService.svc/GetTravelDeskRequestFicci/" + value;
            Log.d(TAG, "getTravelDeskData: " + GET_TRAVELDESKHISTORY_URL);
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, GET_TRAVELDESKHISTORY_URL, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    ...
                    try {
                        ...
                        if (response.length() > 0) {
                            ...
                            travelDeskHistoryFicciAdapter = new TravelDeskHistoryFicciAdapter(getActivity(), arrayList);
                            recyclerView.setAdapter(travelDeskHistoryFicciAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_travel_desk_request_history_ficci, container, false);
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.travelDeskHistoryRecyclerView);
        noDataFound = getActivity().findViewById(R.id.txt_travelDeskHistory);
        ...
        recyclerView.addOnItemTouchListener(new TravelDeskFicciFragment.RecyclerTouchListener(getActivity(), recyclerView, new TravelDeskFicciFragment.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(getActivity(), ItineraryDetailsWithTicketsActivity.class);
    ...
    static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private TravelDeskHistoryFicciFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final TravelDeskHistoryFicciFragment.ClickListener clickListener) {
